...
# Load the h5 file
with h5py.File("C:\\Users\\limyu\\Google Drive\\3d plots\\grating012umpitch05dutycycle15um.h5", 'r') as f:
    # Get the dataset
    dset = f['grating012umpitch05dutycycle15um']
...
ax.set_yticklabels(['-20', '-10', '0', '10', '20'], fontdict={'weight': 'bold'})
